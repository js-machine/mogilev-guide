...
export const SightTab = <TabId extends _TabId>(
  props: SightTabProps<TabId>
...
export const SightTabs = <TabId extends _TabId>({
  children,
  activeTab,
  onChangeTab
}: Props<TabId>): React.ReactElement => {
  return (
    <SightTabsContainer>
      <SightTabsHeader>
        {children.map(tab => {
